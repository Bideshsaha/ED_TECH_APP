            ...
            <div className="max-w-[500px] p-4 lg:p-8">
                ...
                <form onSubmit={handleOnSubmit}>
                    ...
                    />
                        ...
                        >
                            {
                                showPassword ? ( <IoEye fontSize={24} fill="#AFB2BF"/> ): (<IoEyeOffOutline fontSize={24} fill="#AFB2BF"/>
                    ...
                    >
                        {
                            showConfirmPassword ? ( <IoEye fontSize={24} fill="#AFB2BF"/> ): (<IoEyeOffOutline fontSize={24} fill="#AFB2BF"/>)
